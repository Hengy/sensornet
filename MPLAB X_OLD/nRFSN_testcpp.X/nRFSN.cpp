...
------------------------------------------------*/
void nRFSNClass::setSPIFreq(uint16_t freq)
{
...
------------------------------------------------*/
void nRFSNClass::clearInt(uint8_t intNum)
{
...
------------------------------------------------*/
uint8_t nRFSNClass::spiTransfer(uint8_t data)
{
...
------------------------------------------------*/
void nRFSNClass::wEEPROM(uint8_t data, uint8_t address)
{
...
------------------------------------------------*/
uint8_t nRFSNClass::rEEPROM(uint8_t address)
{
    EEADR = address;            // Point to address
